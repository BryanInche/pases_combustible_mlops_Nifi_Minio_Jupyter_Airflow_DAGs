...
def start_processor():
    ...
    if run_status != 'Running':
        ...
        payload = {
            "revision": {
                "clientId": "bf37873b-0191-1000-4303-6f27e2da226a",
                "version": 5,  # Ajusta la versión según corresponda
            },
            "component": {
                "id": processor_id,
                "state": "RUNNING"
        ...
        response = requests.put(start_url, headers=headers, json=payload, verify=False)
        response.raise_for_status()
